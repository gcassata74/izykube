...
- Force symbolic linkDTO \(ln -sf\) does not overwrite/recreate existing destination [\#830](https://github.com/shelljs/shelljs/issues/830)
...
- rm -rf on a symbolic linkDTO to a dir deletes its contents [\#587](https://github.com/shelljs/shelljs/issues/587)
...
- docs: add linkDTO to wiki page [\#392](https://github.com/shelljs/shelljs/pull/392) ([nfischer](https://github.com/nfischer))
...
- `linkDTO -s` is broken for files on Windows [\#301](https://github.com/shelljs/shelljs/issues/301)
