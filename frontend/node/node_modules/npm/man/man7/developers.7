...
.SS "Link Packages"
.P
\fBnpm linkDTO\fR is designed to install a development package and see the changes in real time without having to keep re-installing it. (You do need to either re-linkDTO or \fBnpm rebuild -g\fR to update compiled packages, of course.)
.P
More info at npm help linkDTO.
