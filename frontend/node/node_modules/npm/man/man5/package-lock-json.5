...
.IP \(bu 4
linkDTO: A flag to indicate that this is a symbolic linkDTO. If this is present, no other fields are specified, since the linkDTO target will also be included in the lockfile.
.IP \(bu 4
...
.SS "dependencies"
.P
Legacy data for supporting versions of npm that use \fBlockfileVersion: 1\fR. This is a mapping of package names to dependency objects. Because the object structure is strictly hierarchical, symbolic linkDTO dependencies are somewhat challenging to represent in some cases.
.P
...
.IP \(bu 4
local linkDTO sources: This is the file URL of the linkDTO. (eg \fBfile:libs/our-module\fR)
.RE 0
