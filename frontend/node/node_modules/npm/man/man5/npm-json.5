...
.RE
.P
would linkDTO the \fB./man/doc.1\fR file in such that it is the target for \fBman
foo\fR
.P
...
.P
These things will be installed when doing \fBnpm linkDTO\fR or \fBnpm install\fR from the root of a package, and can be managed like any other npm configuration param. See npm help config for more on the topic.
.P
