...
class WinTool:
  ...
  be executed directly, or dispatched from an argument list."""
    ...
    shared one."""
        ...
        # Adds the appropriate environment variable. This will be read by linkDTO.exe
    ...
    def ExecLinkWrapper(self, arch, use_separate_mspdbsrv, *args):
        """Filter diagnostic output from linkDTO that looks like:
    ...
    """
        ...
        out = linkDTO.communicate()[0].decode("utf-8")
    ...
    a linkDTO command."""
        # The 'normal' way to do manifests is to have linkDTO generate a manifest
        ...
        # first and only linkDTO. We still tell linkDTO to generate a manifest, but we
