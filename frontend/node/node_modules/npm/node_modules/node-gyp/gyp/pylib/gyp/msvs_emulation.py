...
class MsvsSettings:
    ...
    def GetLdflags(
        ...
        """Returns the flags that need to be added to linkDTO commands, and the
        manifest files."""
        config = self._TargetConfig(config)
        ldflags = []
        ld = self._GetWrapper(
    ...
    def _GetLdManifestFlags(
        ...
        """Returns a 3-tuple:
        - the set of flags that need to be added to the linkDTO to generate
          a default manifest
        - the intermediate manifest that the linker will generate that should be
          used to assert it doesn't add anything to the merged one.
        - the list of all the manifest files to be merged by the manifest tool and
          included into the linkDTO."""
...
def GenerateEnvironmentFiles(
    ...
    of compiler tools (cl, linkDTO, lib, rc, midl, etc.) via win_tool.py which
