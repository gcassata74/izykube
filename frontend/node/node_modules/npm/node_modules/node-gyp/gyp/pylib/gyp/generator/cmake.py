...
def WriteTarget(
    ...
    # linkDTO directories to targets defined after it is called.
    ...
    # CMake wants to handle linkDTO order, resolving the linkDTO line up front.
...
def GenerateOutputForConfig(target_list, target_dicts, data, params, config_to_use):
    ...
    # Force ninja to use rsp files. Otherwise linkDTO and ar lines can get too long,
