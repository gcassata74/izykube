...
def ExpandWildcardDependencies(targets, data):
  ...
  targets.  If any such section contains a linkDTO of the form build_file:*, it
  is taken as a wildcard linkDTO, and is expanded to list each target in
  build_file.  The |data| dict provides access to build file dicts.

  Any target that does not wish to be included by wildcard can provide an
  optional "suppress_wildcard" key in its target dict.  When present and
  true, a wildcard dependency linkDTO will not include such targets.
  ...
  """
    ...
    """
        ...
        if initial and not is_linkable:
            ...
            # return an empty list of linkDTO dependencies, because the linkDTO
        ...
        # are already fully and finally linked. Nothing else can be a linkDTO
        ...
        # linkDTO against the shared_library's import lib), but should not be included
        ...
        # The target is linkable, add it to the list of linkDTO dependencies.
...
def AdjustStaticLibraryDependencies(
    ...
    # target's computed list of linkDTO dependencies (including static libraries
...
def Load(
    ...
    # that they need so that their linkDTO steps will be correct.
