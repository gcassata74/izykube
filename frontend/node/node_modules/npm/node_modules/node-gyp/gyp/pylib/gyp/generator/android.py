...
class AndroidMkWriter:
    ...
    def Write(
        ...
        # TODO: doesn't pull in things through transitive linkDTO deps; needed?
    ...
    def WriteTargetFlags(self, spec, configs, link_deps):
        """Write Makefile code to specify the linkDTO flags and library dependencies.

        spec, configs: input from gyp.
        link_deps: linkDTO dependency list; see ComputeDeps()
        """
        # Libraries (i.e. -lfoo)
