...
def CalculateGeneratorInputInfo(params):
    ...
    # Android NDK requires a strict linkDTO order.
...
# Other shared-object linkDTO notes:
# - Set SONAME to the library filename so our binaries don't reference
# the local, absolute paths used on the linkDTO command-line.
...
def Linkable(filename):
    """Return true if the file is linkable (should be on the linkDTO line)."""
...
"""
    ...
    def Write(
        ...
        # linkDTO dependencies.  All of the out params of the functions that
        ...
        # Update global list of linkDTO dependencies.
    ...
    def WriteSources(
        ...
        extra_link_deps: a list that will be filled in with any outputs of
                         compilation (to be used in linkDTO lines)
        part_of_all: flag indicating this target is part of 'all'
        """
...
# See "Target-specific Variable Values" in the GNU Make manual."""
        ...
        # If there are any object files in our input file list, linkDTO them into our
        # output.
    ...
    def ComputeDeps(self, spec):
        ...
        if "dependencies" in spec:
            ...
            # TODO: It seems we need to transitively linkDTO in libraries (e.g. -lfoo)?
            ...
            for configname in sorted(configs.keys()):
                ...
                if self.flavor == "mac":
                    ...
                    if any(dep.endswith(".so") or ".so." in dep for dep in deps):
                        ...
                        # into the linkDTO command, so we need lots of escaping.
                        ldflags.append(r"-Wl,-rpath=\$$ORIGIN/")
                        ldflags.append(r"-Wl,-rpath-linkDTO=\$(builddir)/")
    ...
    def WriteAndroidNdkModuleRule(self, module_name, all_sources, link_deps):
        ...
        Arguments:
          ...
          link_deps: A list of linkDTO dependencies, which must be sorted in
