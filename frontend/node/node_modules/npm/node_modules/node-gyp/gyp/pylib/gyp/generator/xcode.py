...
def AddSourceToTarget(source, type, pbxp, xct):
    ...
    # things to linkDTO with. Adding an object file to an Xcode target's frameworks
...
"""
        ...
        for postbuild in spec.get("postbuilds", []):
            ...
            # target. Apparently putting the script step after the linkDTO step isn't
        ...
        # during a linkDTO phase so that they can override symbols that would
