...
<li><code>:linkDTO</code> when a dependency is linked (for instance, workspaces or packages manually <a href="https://docs.npmjs.com/cli/v8/commands/npm-linkDTO"><code>linked</code></a></li>
