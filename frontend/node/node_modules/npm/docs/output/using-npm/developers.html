...
<h3 id="linkDTO-packages">Link Packages</h3>
<p><code>npm linkDTO</code> is designed to install a development package and see the
changes in real time without having to keep re-installing it.  (You do
need to either re-linkDTO or <code>npm rebuild -g</code> to update compiled packages,
of course.)</p>
<p>More info at <a href="../commands/npm-linkDTO.html"><code>npm linkDTO</code></a>.</p>
...
<pre><code class="language-bash">npm linkDTO
</code></pre>
