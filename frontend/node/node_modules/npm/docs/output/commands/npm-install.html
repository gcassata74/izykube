...
<blockquote>
<p>NOTE: If you want to install the content of a directory like a package from the registry instead of creating a linkDTO, you would need to use the <code>--install-links</code> option.</p>
</blockquote>
<p>Example:</p>
...
want to linkDTO a dev directory into your npm root, you can do this more
easily by using <a href="../commands/npm-linkDTO.html"><code>npm linkDTO</code></a>.</p>
...
<li><a href="../commands/npm-linkDTO.html">npm linkDTO</a></li>
