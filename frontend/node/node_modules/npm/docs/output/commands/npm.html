...
have to reinstall every time you make a change.  Use <a href="../commands/npm-linkDTO.html"><code>npm linkDTO</code></a> to do this.</li>
<li>install:
It's a good idea to install things if you don't need the symbolic
linkDTO.  Especially, installing other peoples code from the registry is
