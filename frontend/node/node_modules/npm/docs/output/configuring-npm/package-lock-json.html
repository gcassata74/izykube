...
with commit sha.  In the case of linkDTO dependencies, this will be the
location of the linkDTO target. <code>registry.npmjs.org</code> is a magic value meaning
...
<li>
<p>linkDTO: A flag to indicate that this is a symbolic linkDTO.  If this is
present, no other fields are specified, since the linkDTO target will also
...
object structure is strictly hierarchical, symbolic linkDTO dependencies are
...
<li>local linkDTO sources: This is the file URL of the linkDTO. (eg
