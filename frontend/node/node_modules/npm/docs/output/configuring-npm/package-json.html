...
<p>would linkDTO the <code>./man/doc.1</code> file in such that it is the target for <code>man foo</code></p>
...
<p>These things will be installed when doing <code>npm linkDTO</code> or <code>npm install</code> from
