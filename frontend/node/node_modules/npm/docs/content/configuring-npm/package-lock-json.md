...
* resolved: The place where the package was actually resolved from.  In
  ...
  location of the linkDTO target. `registry.npmjs.org` is a magic value meaning
...
* linkDTO: A flag to indicate that this is a symbolic linkDTO.  If this is
...
* version: a specifier that varies depending on the nature of the package,
  and is usable in fetching a new copy of it.
    ...
    * local linkDTO sources: This is the file URL of the linkDTO. (eg
